        ...
        private static void Check()
        {
            ...
            if (hasTerrainPackage && !hasTerrainDefine)
            {
                if (EditorUtility.DisplayDialog(
                    "MLP Dependency Checker", 
                    "The \"Terrain\" package is installed in the project, \"Scripting Define Symbols\" will be automatically configured.", 
                    "OK"))
                {
            ...
            else if (!hasTerrainPackage && hasTerrainDefine)
            {
                if (EditorUtility.DisplayDialog(
                    "MLP Dependency Checker", 
                    "The \"Terrain\" package is not installed in the project, \"Scripting Define Symbols\" will be automatically configured.", 
                    "OK"))
                {
            ...
            if (hasBakeryPackage && !hasBakeryDefine)
            {
                if (EditorUtility.DisplayDialog(
                    "MLP Dependency Checker", 
                    "The \"Bakery\" package is installed in the project, \"Scripting Define Symbols\" will be automatically configured.", 
                    "OK"))
                {
            ...
            else if (!hasBakeryPackage && hasBakeryDefine)
            {
                if (EditorUtility.DisplayDialog(
                    "MLP Dependency Checker", 
                    "The \"Bakery\" package is not installed in the project, \"Scripting Define Symbols\" will be automatically configured.", 
                    "OK"))
                {
            ...
            if (hasHDRPPackage && !hasHDRPDefine)
            {
                if (EditorUtility.DisplayDialog(
                    "MLP Dependency Checker", 
                    "The \"HDRP\" package is installed in the project, \"Scripting Define Symbols\" will be automatically configured.", 
                    "OK"))
                {
            ...
            else if (!hasHDRPPackage && hasHDRPDefine)
            {
                if (EditorUtility.DisplayDialog(
                    "MLP Dependency Checker", 
                    "The \"HDRP\" package is not installed in the project, \"Scripting Define Symbols\" will be automatically configured.", 
                    "OK"))
                {
